...
<section>
    ...
    <p>With this perspective, it really feels like it has to be this way. At least for me. It's a lot of work to set up something like this from scratch, but I don't want just another WordPress or Substack or whatever people are using these days. I want something that's <i>uniquely mine</i> that gets to show off what I want in my website, and I don't really care if that means it took me 16 months to make a second post. Damn the difficulties, it'll be mine and it'll be mine <i>with style</i>.</p>
</section>

<section>
    <h3>blog as a vehicle of self-expression</h3>
    <p>Something I have been realizing recently is that I am not actually very good at expressing myself. There's a couple of reasons for this. One is that I have a lot of niche interests, and outside of those interests I know basically nothing. This leads to not being able to find too many people I overlap with. This leads into the second reason, which is that I'm <b><i>terrible</i></b> at talking to people. They always talk about stuff I have no knowledge about or don't care about, and trying to find an opportunity in the converstation to talk about what I'm interested in is a nightmare. Even hanging out in inclusive spaces, it can be really tough for me to try and get my word in. It also doesn't help that I'm pretty slow to come up with responses to people.</p>

    <p>The end result of all this is that there's a lot of stories hanging out in my brain that are screaming to get out, but I just can't find the right time and place for them. That's where blogging comes in. You can take as long as you want to think about how you want to say something, you don't have to worry about trying to interrupt the conversation at the right time, and you don't have to care about anyone actually being interested about what you have to say. You can just throw whatever you want to say on there, and just having it there means you can just link people to the page where you already did all the hard effort of putting it into words. To me at least, it's the perfect form of self-expression, and it's what I've needed for quite some time now.</p>
</section>