...
<main>
    ...
    <section>
        ...
        <ul>
            ...
            <li><a href="talks/bignumbers.pdf">Big Numbers</a>:</li>
            <li><a href="talks/axiomofchoice.pdf">A Talk on the Axiom of Choice</a>:</li>
            <li><a href="talks/hott.pdf">Homotopy Type Theory (unfinished)</a>:</li>
        </ul>
    </section>
    <section>
        <h3>papers</h3>
